...
(function (root, factory) {
  ...
  protoOf(Long).r = function () {
    return new Long(~this.f_1, ~this.g_1);
  };
  protoOf(Long).s = function () {
    return this.f_1;
  };
  protoOf(Long).h = function () {
  ...
  function add(_this__u8e3s4, other) {
    _init_properties_longjs_kt__tqrzid();
    var a48 = _this__u8e3s4.g_1 >>> 16 | 0;
    var a32 = _this__u8e3s4.g_1 & 65535;
    var a16 = _this__u8e3s4.f_1 >>> 16 | 0;
    var a00 = _this__u8e3s4.f_1 & 65535;
    var b48 = other.g_1 >>> 16 | 0;
    var b32 = other.g_1 & 65535;
    var b16 = other.f_1 >>> 16 | 0;
    var b00 = other.f_1 & 65535;
    var c48 = 0;
    var c32 = 0;
    var c16 = 0;
    var c00 = 0;
  ...
  function shiftLeft(_this__u8e3s4, numBits) {
    ...
    if (numBits_0 === 0) {
      ...
      if (numBits_0 < 32) {
        return new Long(_this__u8e3s4.f_1 << numBits_0, _this__u8e3s4.g_1 << numBits_0 | (_this__u8e3s4.f_1 >>> (32 - numBits_0 | 0) | 0));
      } else {
        return new Long(0, _this__u8e3s4.f_1 << (numBits_0 - 32 | 0));
      }
    }
  }
  function shiftRight(_this__u8e3s4, numBits) {
    ...
    if (numBits_0 === 0) {
      ...
      if (numBits_0 < 32) {
        return new Long(_this__u8e3s4.f_1 >>> numBits_0 | 0 | _this__u8e3s4.g_1 << (32 - numBits_0 | 0), _this__u8e3s4.g_1 >> numBits_0);
      } else {
        return new Long(_this__u8e3s4.g_1 >> (numBits_0 - 32 | 0), _this__u8e3s4.g_1 >= 0 ? 0 : -1);
      }
    }
  }
  function toNumber(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.g_1 * 4.294967296E9 + getLowBitsUnsigned(_this__u8e3s4);
  }
  function equalsLong(_this__u8e3s4, other) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.g_1 === other.g_1 ? _this__u8e3s4.f_1 === other.f_1 : false;
  }
  ...
  function isZero(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.g_1 === 0 ? _this__u8e3s4.f_1 === 0 : false;
  }
  function isOdd(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return (_this__u8e3s4.f_1 & 1) === 1;
  }
  ...
  function getLowBitsUnsigned(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.f_1 >= 0 ? _this__u8e3s4.f_1 : 4.294967296E9 + _this__u8e3s4.f_1;
  }
