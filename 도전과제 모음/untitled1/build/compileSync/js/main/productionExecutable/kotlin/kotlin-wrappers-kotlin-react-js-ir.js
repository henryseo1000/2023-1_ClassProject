(function (root, factory) {
  ...
  protoOf(ChildrenBuilderImpl).w = unaryPlus;
  protoOf(ChildrenBuilderImpl).x = unaryPlus_0;
  protoOf(ChildrenBuilderImpl).v = child;
  protoOf(ChildrenBuilderImpl).y = invoke;
  //endregion
